---
title: "おまえら、NFTとメタバースとWeb3について、勘違いしてないか？"
emoji: "💰"
...
この記事は、Qiitaの[NFT Advent Calendar2021](https://qiita.com/advent-calendar/2021/nft)の17日目の記事であり、記載内容は投稿日時時点の情報です。目下、表題のバズワードに関する記事は玉石混交です。
